...
const blogs = [
  ...
  },
  {
    ...
    image: {
      link: 'https://ik.imagekit.io/p9k6bhc9p/Lets/letsblogneck.JPG'
    },
    ...
    blogsections: [
      ...
      },
      {
        ...
        blogsectiontext: "The first thing was to find a freely available 3d model of the characters. There are tons of resources and we got our man model from - Renderpeople's 3d models.\n The next step was to skin and rig it. Now that procedure is particularly painful and is made very painless by Mixamo. Mixamo is a library of freely available animations online and has this pipeline where you upload a 3d model and as long as it's humanoid-ish. then you can get a really well rigged model.\n Once that's done, you'll see a neck bone inside the bone heirarchy of the model which will flow somewhat like hip->spine->neck. Now comes the simplest part, the code! And all it is, is telling the neck bone to rotate to look at the camera",
        bloggridsections: [
          {
            span: 4,
            list: [
      ...
      },
      {
        ...
        blogsectiontext: "Lightning happens intermittently and there's a flashing with a sound delayed. The only place it'll be witnessed is near an open window.\n Now if there was a light outside the window which flickered with the same varying intensity over different random intervals, we'll have ourselves a lightning effect!\n In the following snippet of code we can see that the Flickr coroutine oscillates between max and min intensity to give the flashing effect and then it dies down for a few seconds as we yield and starts again after a while hence giving the lightning effect via a spotlight aimed at the window!",
        bloggridsections: [
          {
            image: { link: 'https://ik.imagekit.io/p9k6bhc9p/Lets/letsbloglightining.JPG' }
          }
        ]
      },
      {
        ...
        bloggridsections: [
          {
            image: { link: 'https://ik.imagekit.io/p9k6bhc9p/Lets/letsheadturn.gif' }
          },
          {
            image: { link: 'https://ik.imagekit.io/p9k6bhc9p/Lets/letscrawlies.gif' }
          }
        ]
      }
    ]
  },
  {
    ...
    image: {
      link: 'https://ik.imagekit.io/p9k6bhc9p/YouAreNotAlone/YNACRAWLIES.jpg'
    },
    externallink: "/blog/howbulbeffect",
    blogsections: [
      {
        blogsectiontitle: "Situation",
        blogsectiontext: "The aim of the 'you are not alone' little prototype was to see if we can create a light based mechanic. Being the halloween season we settled on a bulb character who needs to solve puzzles and get through doors and make sure the light never goes out. So once you pick up a battery and consume it, the light radius will increase and otherwise it will slowly diminish until the creepy crawlies who only stay in the darkness surround you.",
        bloggridsections: []
      },
      {
        blogsectiontitle: "Task",
      ...
      },
      {
        ...
        blogsectiontext: "The first thing was to reduce the area of effect and intensity at the same time. Fortunately unity's light system already has an area of effect and intensity parameter and all that was needed was to have a coroutine that diminished both linearly over time and set a radius that can be used by the creepy crawlie script! We use Navmesh to bake a movement plane and have our agents - the creepy crawlies move based on location given.",
        bloggridsections: [
          {
            title: "Area of light [courtesy of unity's website]",
            image: { link: 'https://ik.imagekit.io/p9k6bhc9p/YouAreNotAlone/Light-Point.jpg' }
          },
          {
            ...
            image: { link: 'https://ik.imagekit.io/p9k6bhc9p/YouAreNotAlone/spread%20circle.JPG' }
          }
        ]
      },
      {
        ...
        bloggridsections: [
          {
            image: { link: 'https://ik.imagekit.io/p9k6bhc9p/YouAreNotAlone/ynabulbeffect.gif' }
          }
        ]
      }
    ]
  },
  {
    ...
    image: {
      link: 'https://ik.imagekit.io/p9k6bhc9p/ItsNotReal/occlusion.JPG'
    },
    ...
    blogsections: [
        ...
        bloggridsections: [
          {
            ...
            image: {
              link: 'https://ik.imagekit.io/p9k6bhc9p/ItsNotReal/markvalid.JPG'
            }
          }
        ]
      },
      {
        blogsectiontitle: "Approach",
        blogsectiontext: "We watched this excellent video by Scott Steffers of Kingdom of Knight game and prepared the following approach to solving the problem. We learnt that for isometric games the rendering logic should be over whichever two sprites that are intersecting. For this isometric game, the lower and the more left you go, the more you will be brought to the front. With that in mind here were the steps.",
        bloggridsections: [
          {
            video: {
              link: 'https://ik.imagekit.io/p9k6bhc9p/ItsNotReal/yRZlVrinw9I'
            }
          },
          {
            list: [
            ...
            image: {
              link: 'https://ik.imagekit.io/p9k6bhc9p/ItsNotReal/inrblogfindextremeties.JPG'
            }
          },
          {
            list: [
            ...
            image: {
              link: 'https://ik.imagekit.io/p9k6bhc9p/ItsNotReal/inrpointopointcheck.JPG'
            }
          },
          {
            list: [
              ...
              { label: "2.b) We take the diagonal that passes through (xmin,ymax) and (xmax,ymin) because that satisfies our rendering rule about \"the lower and the more left you go, the more you will be brought to the front.\" " },
            ...
            image: {
              link: 'https://ik.imagekit.io/p9k6bhc9p/ItsNotReal/inrpointtolinecheck.JPG'
            }
          }
        ]
      },
      {
        ...
        bloggridsections: [
          {
            image: { link: 'https://ik.imagekit.io/p9k6bhc9p/ItsNotReal/inrspriterendering.gif' }
          }
        ]
      }
    ]
  },
  {
    ...
    image: {
      link: 'https://ik.imagekit.io/p9k6bhc9p/ItsNotReal/inr.JPG'
    },
    ...
    blogsections: [
      ...
      },
      {
        ...
        bloggridsections: [
          ...
          },
          {
            ...
            image: {
              link: 'https://ik.imagekit.io/p9k6bhc9p/ItsNotReal/inrfishlinekinematiconfo.JPG'
            }
          },
          {
            span: 2,
            list: [
              ...
              { label: "Using the kinematic info object we have the initial velocity, time(t) that should be taken for the object to reach is 't' and given in the kinematic info object. So by that logic at every t1=t/n value there will be a point of line renderer" },
            ...
            image: {
              link: 'https://ik.imagekit.io/p9k6bhc9p/ItsNotReal/inrfishlinerender.JPG'
            }
          }
        ]
      },
      {
        ...
        bloggridsections: [
          {
            image: { link: 'https://ik.imagekit.io/p9k6bhc9p/ItsNotReal/inrfishline.gif' }
          }
        ]
      }
    ]
  },
  {
    ...
    image: {
      link: 'https://ik.imagekit.io/p9k6bhc9p/WillWindowsWin/wwwrobbervirus.gif'
    },
    ...
    blogsections: [
        ...
        bloggridsections: [
          {
            ...
            image: {
              link: 'https://ik.imagekit.io/p9k6bhc9p/WillWindowsWin/ransomgiffffff.gif'
            }
          },
          {
            span: 2,
            ...
            image: {
              link: 'https://ik.imagekit.io/p9k6bhc9p/WillWindowsWin/ransomware.JPG'
            }
          },
          {
            span: 2,
            ...
            image: {
              link: 'https://ik.imagekit.io/p9k6bhc9p/WillWindowsWin/triggehunt.JPG'
            }
          }
        ]
      },
      {
        ...
        bloggridsections: [
          {
            image: { link: 'https://ik.imagekit.io/p9k6bhc9p/WillWindowsWin/wwwrobbervirus.gif' }
          }
        ]
      }
    ]
...
const jobs = [
...

  {
    ...
    image: {
      link: 'https://ik.imagekit.io/p9k6bhc9p/SciVista/ezgif-4-0d9c6fc83e.gif'
    },
    ...
    sections: [
      ...
      },
      {
        ...
        image: {
          link: 'https://ik.imagekit.io/p9k6bhc9p/SciVista/environments.JPG'
        }
      },
      {
        span: 2,
        ...
        image: {
          link: 'https://ik.imagekit.io/p9k6bhc9p/SciVista/helpertext.gif'
        }
      },
      {
      ...
      },
      {
        ...
        image: {
          link: 'https://ik.imagekit.io/p9k6bhc9p/SciVista/lobbyspace.gif'
        }
      },
      {
        span: 2,
      ...
      },
      {
        ...
        image: {
          link: 'https://ik.imagekit.io/p9k6bhc9p/SciVista/quickaction.gif'
        }
      },
      {
        span: 2,
        ...
        image: {
          link: 'https://ik.imagekit.io/p9k6bhc9p/SciVista/webbrowser.gif'
        }
      },
      {
      ...
      },
      {
        ...
        image: {
          link: 'https://ik.imagekit.io/p9k6bhc9p/SciVista/subscription.JPG'
        }
      },
      {
        span: 1,
  ...
  dungeonsAndDragons: [
    {
      ...
      image: { link: 'https://ik.imagekit.io/p9k6bhc9p/D&D/WhatsApp%20Image%202024-12-13%20at%2020.55.22%20(26).jpeg' },
      ...
      sections: [
        ...
        {
          image: { link: 'https://ik.imagekit.io/p9k6bhc9p/D&D/PXL_20230806_181004419.jpg' },
        ...
        {
          image: { link: 'https://ik.imagekit.io/p9k6bhc9p/D&D/PXL_20240229_022417269.LONG_EXPOSURE-01.COVER.jpg' },
        ...
        {
          image: { link: 'https://ik.imagekit.io/p9k6bhc9p/D&D/PXL_20230807_000539203.jpg' },
        ...
        {
          image: { link: 'https://ik.imagekit.io/p9k6bhc9p/D&D/15.jpeg' },
        ...
        {
          image: { link: 'https://ik.imagekit.io/p9k6bhc9p/D&D/IMG_20230513_222255.jpg' },
          title: 'Simpler Times',
        ...
        {
          video: {
            link: 'https://imagekit.io/player/embed/p9k6bhc9p/D&D/IMG_5991.MOV?updatedAt=1746313515730&ik-s=edd4961bcf74377b77d4f523fd2e09313abc779b'
          },
        ...
        {
          video: {
            link: 'https://imagekit.io/player/embed/p9k6bhc9p/D&D/WhatsApp%20Video%202024-12-13%20at%2020.55.22%20(4).mp4'
          },
          title: 'Dread Spider',
        ...
        {
          image: { link: 'https://ik.imagekit.io/p9k6bhc9p/D&D/PXL_20230520_062526230.jpg' },
          title: 'Final Battle of Campaign 1',
          subtitle: 'Campaign 1, one of the final battles. Here there be displacer beasts!',
          span: 2
        },
        {
          image: { link: 'https://ik.imagekit.io/p9k6bhc9p/D&D/WhatsApp%20Image%202024-12-13%20at%2020.55.22%20(31).jpeg' },
        ...
        {
          image: { link: 'https://ik.imagekit.io/p9k6bhc9p/D&D/PXL_20240818_195124587.jpg' },
        ...
        {
          image: { link: 'https://ik.imagekit.io/p9k6bhc9p/D&D/PXL_20240915_194053345.jpg' },
          title: 'Sunny Look of the Set',
          subtitle: 'A more sunny look of the set.',
          span: 2
        },
        {
          image: { link: 'https://ik.imagekit.io/p9k6bhc9p/D&D/news2.jpeg' },
        ...
        {
          image: { link: 'https://ik.imagekit.io/p9k6bhc9p/D&D/PXL_20240818_193346327.MP.jpg' },
          title: 'Arrrr',
          subtitle: 'Arrrr',
          span: 2
        },
        ...
        {
          image: { link: 'https://ik.imagekit.io/p9k6bhc9p/D&D/PXL_20230806_191708143.jpg' },
        ...
        {
          image: { link: 'https://ik.imagekit.io/p9k6bhc9p/D&D/PXL_20240818_195215821.jpg' },
        ...
        {
          image: { link: 'https://ik.imagekit.io/p9k6bhc9p/D&D/30.jpeg' },
          title: 'Tensions Are High',
          subtitle: 'Tensions are high, will there be TPK tonight?',
          span: 2
        },
        {
          image: { link: 'https://ik.imagekit.io/p9k6bhc9p/D&D/PXL_20240824_093113188.jpg' },
        ...
        {
          image: { link: 'https://ik.imagekit.io/p9k6bhc9p/D&D/WhatsApp%20Image%202024-12-13%20at%2021.47.06.jpeg' },
          title: 'Last Session of Campaign 1',
          subtitle: 'The last session of Blood Awakening campaign 1.',
          span: 2
        },
        {
          image: { link: 'https://ik.imagekit.io/p9k6bhc9p/D&D/IMG_5947.HEIC' },
  ...
  projects: [
    {
      ...
      image: {
        link: 'https://ik.imagekit.io/p9k6bhc9p/Lets/letsbabyscreen.jpg'
      },
      ...
      sections: [
        ...
        },
        {
          span: 2,
          image: {
            link: 'https://ik.imagekit.io/p9k6bhc9p/Lets/letsallred.jpg'
          }
        },
        {
          span: 2,
          image: {
            link: 'https:///ik.imagekit.io/p9k6bhc9p/Lets/letscrawlies.gif'
          }
        },
        {
        ...
        },
        {
          span: 2,
          image: {
            link: 'https://ik.imagekit.io/p9k6bhc9p/Lets/letsdevil.jpg'
          }
        },
        {
          span: 2,
          image: {
            link: 'https://ik.imagekit.io/p9k6bhc9p/Lets/letseyesred.gif'
          }
        },
        {
        ...
        },
        {
          span: 2,
          image: {
            link: 'https://ik.imagekit.io/p9k6bhc9p/Lets/letsheadturn.gif'
          }
        },
        {
          span: 2,
    ...
    },
    {
      ...
      team: "Gourav Acharya, Shayne Dsouza",
      image: {
        link: 'https://ik.imagekit.io/p9k6bhc9p/YouAreNotAlone/YNAMENU.jpg'
      },
      ...
      sections: [
        ...
        },
        {
          span: 2,
          image: {
            link: 'https://ik.imagekit.io/p9k6bhc9p/YouAreNotAlone/ynaplatfomring.gif'
          }
        },
        {
          span: 2,
        ...
        },
        {
          span: 2,
          image: {
            link: 'https://ik.imagekit.io/p9k6bhc9p/YouAreNotAlone/ynabulbeffect.gif'
          }
        },
        {
    ...
    },
    {
      ...
      sections: [
        ...
        },
        {
          span: 2,
          image: {
            link: 'https://ik.imagekit.io/p9k6bhc9p/ItsNotReal/inrfishline.gif'
          }
        },
        {
          ...blogs[2]
    ...
    },
    {
      ...
      team: "Gourav Acharya, Shayne Dsouza",
      image: {
        link: 'https://ik.imagekit.io/p9k6bhc9p/WillWindowsWin/wwwmainscreen.JPG'
      },
      ...
      sections: [
        ...
        },
        {
          span: 1,
          image: {
            link: 'https://ik.imagekit.io/p9k6bhc9p/WillWindowsWin/wwwbill.JPG'
          }
        },
        {
          ...
          image: { link: 'https://ik.imagekit.io/p9k6bhc9p/WillWindowsWin/gap.gif' }
        },
        {
          title: "There was parallax also put into the background and some errors persisted in the back not attacking Will.",
          image: { link: 'https://ik.imagekit.io/p9k6bhc9p/WillWindowsWin/wwwerror.jpg' }
        },
        {
          title: "Had a fun final screen",
          image: { link: 'https://ik.imagekit.io/p9k6bhc9p/WillWindowsWin/wwwnevergonna.gif' }
        },
        {
          ...blogs[4]
        }
